...
public class GameHUDCanvas3D : MonoBehaviour
{
    ...
    void OnGUI()
    {
        ...
        GUI.Label(new Rect(12, Screen.height - 64, 1200, 28), "Benchmark: F6 start   Quality: F7 Low, F8 Medium, F9 High", _style);
    ...
    void DrawStartPanel(GameManager3D gm)
    {
        ...
        GUI.Label(new Rect(x + 70f, y + 236f, panelW - 140f, 100f), "Kill all monsters, then enter green portal.", _menuTextStyle);
